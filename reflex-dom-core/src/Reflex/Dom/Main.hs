...
mainHydrationWidgetWithHead w1 w2 = mainHydrationWidgetWithHead' w1 w2
...
mainHydrationWidgetWithSwitchoverAction s w1 w2 = mainHydrationWidgetWithSwitchoverAction' s w1 w2
